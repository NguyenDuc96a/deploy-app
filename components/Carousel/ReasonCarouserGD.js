                ...
                <Grid item xs={12} md={4}  >
                    <Paper sx={{ minHeight: '70vh', background: '#1A61A2 ' }} >
                        <Stack spacing={2} padding={7} justifyContent="space-around" textAlign={'left'} color={'#fff'}>
                            ...
                            <Typography> TTC Energy có nhiều năm kinh nghiệm trong quản lý và vận hành các dự án thuộc ngành năng lượng.</Typography>
...
export default ReasonCarouserGD